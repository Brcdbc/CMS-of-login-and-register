<template>
  <div class="article-detail">
    ...
    <el-button type="text" @click="open" class="delete-button">删除</el-button>
    <el-breadcrumb separator-class="el-icon-arrow-right">
      <el-breadcrumb-item :to="{ path: '/main' }">首页</el-breadcrumb-item>
      <el-breadcrumb-item :to="{ path: '/my' }">我的文章</el-breadcrumb-item>
    ...
    <el-button @click="open1" v-if="isEditing">保存 </el-button>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    open1() {
      this.$confirm('是否确定修改本篇文章? (不想保存可以直接退出)', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      }).then(() => {
