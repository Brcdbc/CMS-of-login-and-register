...
export const logout = () => {return axios.post(`http://localhost:8000/api/userapi/logout/`)}
...
export const paixu = () => {return axios.post(`http://localhost:8000/api/userapi/renumber_articles/`)}